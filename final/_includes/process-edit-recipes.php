...
$query = "UPDATE recipes SET title = '{$title_value}', prep_time = '{$prep_time_value}', cook_time = '{$cook_time_value}', serving_size = '{$serving_size_value}', ingredients = '{$ingredients_value}' , instructions = '{$instructions_value}' WHERE id = {$id_value}";
